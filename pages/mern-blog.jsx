		...
		<div className="w-full">
			<div className="w-screen h-[50vh] relative">
				...
				<div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2">
					<h2 className="py-2">Mern-Blog</h2>
					<h3>Mongo / Express / React JS / Node </h3>
				</div>
			</div>
			...
			<div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8">
				<div className="col-span-4">
					...
					<h2>Overview</h2>
					<p>
						This App is buiding by MERN. Is a full-stack solution named after the
					...
					<a
						href="https://github.com/PavelGroshevskiy/Blog_MERN_fullstack"
						target="_blank"
						rel="noreferrer"
					>
						<button className="px-8 py-2 mt-4 mr-8">Code</button>
					</a>
					<a href="https://mern-blog-jv6f.onrender.com/" target="_blank" rel="noreferrer">
